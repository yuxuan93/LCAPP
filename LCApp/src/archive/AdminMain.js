...
import AdminViewCurrent from './AdminViewCurrent';
...
export default class AdminMain extends Component {
    ...
    const content = this.state.loading ? <ActivityIndicator size="large"/> :
       this.state.user &&
        <View style={{flexDirection:'column'}}>
          ...
          <TouchableHighlight onPress={this.adminViewCurrent.bind(this)} style={styles.primaryButton}>
            <Text style={styles.primaryButtonText}>View All Jobs</Text>
          </TouchableHighlight>

          <TouchableHighlight onPress={this.adminAddJob.bind(this)} style={styles.primaryButton}>
            <Text style={styles.primaryButtonText}>Add Job</Text>
          </TouchableHighlight>
  ...
  adminViewCurrent() {
    ...
    this.props.navigator.push({
      component: AdminViewCurrent
    });
    
  }
}

AppRegistry.registerComponent('AdminMain', () => AdminMain);