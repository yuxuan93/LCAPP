...
export default class AdminViewCompleted extends Component {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flex:1, flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end'}}>
          ...
          <ActionButton2 title="ViewCurrent" onPress={this.goToAdminViewCurrent.bind(this)}/>
          <ActionButton title="ViewCompleted" onPress={this}/>          
        </View>
      </View>
